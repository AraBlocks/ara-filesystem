...
test('add() valid did, valid password, no paths', async (t) => {
  ...
  await t.throws(add({ did, password: kPassword }), TypeError, 'ara-filesystem.add: Expecting one or more filepaths to add')
})
...
test('add() valid did, valid password, valid path (1)', async (t) => {
  ...
  await add({ did, paths, password: kPassword })
...
test('add() valid did, valid password, invalid path (1)', async (t) => {
  ...
  await t.throws(add({ did, paths, password: kPassword }), Error, 'ara-filesystem.add: File does not exit.')
})
...
test('add() valid did, invalid password, no paths', async (t) => {
  ...
  await t.throws(add({ did, password: 'wrongpass' }), TypeError, 'ara-filesystem.add: Expecting one or more filepaths to add')
})
...
test('add() valid did, invalid password, valid path (1)', async (t) => {
  ...
  await t.throws(add({ did, paths, password: 'wrongpass' }), Error, 'ara-filesystem.create: incorrect password')
})
...
test('add() invalid did, valid password, no paths', async (t) => {
  await t.throws(add({ did: 'invaliddid', password: kPassword }), TypeError, 'ara-filesystem.create: Unable to resolve AFS DID')
})

test('add() invalid did, valid password, valid path (1)', async (t) => {
  const paths = ['./index.js']

  await t.throws(add({ did: 'invaliddid', paths, password: kPassword }), TypeError, 'ara-filesystem.create: Unable to resolve AFS DID')
})
...
test('add() invalid did, invalid password, no paths', async (t) => {
  await t.throws(add({ did: 'invaliddid', password: 'wrongpass' }), TypeError, 'ara-filesystem.add: Expecting one or more filepaths to add')
})

test('add() invalid did, invalid password, valid path (1)', async (t) => {
  const paths = ['./index.js']

  await t.throws(add({ did: 'invaliddid', paths, password: 'wrongpass' }), TypeError, 'ara-filesystem.create: Unable to resolve AFS DID')
})
